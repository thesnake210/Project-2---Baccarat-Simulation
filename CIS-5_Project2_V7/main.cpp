    ...
    bool fnd; //True or false if score found
        ...
        if (view=='y'|| view=='Y') {
            ...
            for (int j=0; j<SIZE; j++) { //Displays names, scores, and rounds, respectively
                cout << setw(15) << names[j] << " " << scrRnd[j][0] << " " << scrRnd[j][1] << endl; //Output using 2d array 
                ...
                if (asc=='y' || asc=='Y') {
                    ...
                    for (int k=0; k<SIZE; k++) {
                        cout << setw(15) << names[k] << " " << scores[k] << " " << rounds[k] << endl; //Single dimensional array output post-bubble sort
                    }
