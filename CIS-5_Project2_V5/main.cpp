...
bool binSrch(int [], const int, int, int); //Binary search which displays index if found
            ...
            if (asc == 'y' || 'Y') {
                ...
                do {
                    ...
                    if (scr=='y' || scr=='Y') {
                        ...
                        binSrch(scores, SIZE, sScr, index); //runs function to find presence and index of score entered
